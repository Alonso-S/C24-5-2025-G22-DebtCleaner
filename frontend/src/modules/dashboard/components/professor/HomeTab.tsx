...
const HomeTab: React.FC<HomeTabProps> = ({ userName }) => {
  return (
    <div className="space-y-6">
      <WelcomeCard userName={userName} text="Gestiona tus cursos y estudiantes desde este panel." />

      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card title="Cursos Recientes" variant="primary">
          <div className="p-4">
            <EmptyState
              title="No hay cursos recientes"
              description="Los cursos que visite recientemente aparecerán aquí"
              icon={
                <svg
        ...
        <Card title="Actividad Reciente" variant="secondary">
          <div className="p-4">
            <EmptyState
